...
<body>
        ...
        <div class="bg-white w-5/6 rounded-xl mt-6 ml-28 flex">
            <div class="bg-yellow-200 w-3/5 rounded-l-xl flex-col">
                ...
                <div class="bg-white h-16 flex-col flex justify-center items-center">
                    ...
                    <input type="text" placeholder="Masukkan Nama Lengkap" class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400"></input>
                </div>
                <div class="bg-white h-16 flex-col flex justify-center items-center">
                    <div class="bg-white w-52 h-5 -ml-80 text-sm font-semibold">No HP*</div>
                    <input type="text" placeholder="Masukkan Nomor HP" class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400"></input>
                </div>
                <div class="bg-white h-16 flex-col flex justify-center items-center">
                <div class="bg-white w-52 h-5 -ml-80 text-sm font-semibold">Instansi Tujuan*</div>
                    <select class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400">
                        <option></option>
                        <option></option>
                    </select>
                </div>
                ...
                <div class="bg-white w-52 h-5 -ml-80 text-sm font-semibold">Bidang Tujuan*</div>
                    <select placeholder="Pilih Instansi Tujuan" class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400">
                        <option></option>
                        <option></option>
                    </select>
                </div>
                <div class="bg-white h-16 flex-col flex justify-center items-center">
                    ...
                    <input type="date" class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400"></input>
                </div>
                <div class="bg-white h-16 flex-col flex justify-center items-center">
                    <div class="bg-white w-52 h-5 -ml-80 text-sm font-semibold">Lampiran*</div>
                    <input type="file" class="bg-white w-5/6 h-10 rounded-lg pl-4 text-base font-semibold border-2 border-gray-400"></input>
                </div>
                <div class="bg-white h-24 flex-col flex justify-center items-center">
                    ...
                    <textarea placeholder="Tuliskan Keperluan Saat Berkunjung" name="keperluan" class="bg-white w-5/6 h-14 rounded-lg pl-4 text-base font-semibold resize border-2 border-gray-400"></textarea>
                </div>
                <div class="bg-white h-16 flex-col flex justify-center items-center rounded-bl-xl">
                <button type="submit" class="bg-blue-500 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-xl w-5/6 h-10">Kirim</button>
                </div>
            </div>
    ...
    <div class="bg-blue-300 w-screen h-16"></div>
</body>
</html>