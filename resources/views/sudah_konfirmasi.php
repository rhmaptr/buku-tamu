...
<body>
    ...
    <div class="bg-white w-screen h-12 flex rounded-b-xl">
        ...
        <div class="bg-transparent w-screen h-40 -mt-20 flex items-center justify-center">
            <div class="bg-white w-1/3 h-32 rounded-xl flex items-center border-4 border-white hover:border-blue-600 shadow-xl">
            ...
            <div class="bg-white w-1/3 h-32 ml-60 rounded-xl flex items-center justify-center shadow-xl border-4 border-green-400">
            <div class="bg-white w-1/3 h-28 flex items-center justify-center">
        ...
        <div class="bg-gray-50 w-screen h-10 flex">
            ...
            <select class="w-1/3 h-10 rounded-lg border-2 border-gray-100 shadow-lg text-base font-medium pl-4 ml-60">
                <option value="">Semua data</option>
                <option value="">Data di Terima</option>
                <option value="">Data di Tolak</option>
            </select>
        </div>
        <div class="bg-gray-50 w-screen h-screen">
        <div class="bg-green-400 w-5/6 h-12 rounded-lg flex items-center shadow-lg ml-28 mt-8">
            ...
            <div class="bg-transparent w-5/6 h-5/6 ml-28 mt-4 flex-col overflow-y-auto border-2 border-green-300 rounded-xl">
                <div class="bg-white w-full h-12 rounded-lg flex mt-4 shadow-lg">
                    ...
                    <div class="bg-white w-48 h-12 ml-4 text-base font-semibold flex items-center justify-center">
                        <button class="bg-green-300 w-32 h-8 rounded-lg text-white text-base font-semibold flex items-center justify-center hover:bg-green-600">Detail</button>
                    </div>
                </div>
            </div>
        </div>
